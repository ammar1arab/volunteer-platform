...
export const userApi = {
  ...
  updateUserById:    (id: string, data: UpdateAdminInfoRequest) => apiClient.patch<UpdateUserResponse>(API_ENDPOINTS.USERS.BY_ID(id), data),
  ...
  updatePermissions: (id: string, permissions: string[])        => apiClient.patch<UpdatePermissionsResponse>(API_ENDPOINTS.USERS.BY_ID(id), { permissions }),
