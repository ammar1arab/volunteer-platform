...
export const activityApi = {
  getAll: () => apiClient.get<GetAllActivitiesResponse>(API_ENDPOINTS.ACTIVITIES.BASE),
  getPublished: () => apiClient.get<GetAllActivitiesResponse>(API_ENDPOINTS.ACTIVITIES.PUBLISHED),
  getOne: (id: string) => apiClient.get<GetActivityResponse>(API_ENDPOINTS.ACTIVITIES.BY_ID(id)),
  create: (data: CreateActivityRequest) => apiClient.post<CreateActivityResponse>(API_ENDPOINTS.ACTIVITIES.BASE, data),
  update: (id: string, data: UpdateActivityRequest) =>
    apiClient.put<UpdateActivityResponse>(API_ENDPOINTS.ACTIVITIES.BY_ID(id), data),
  delete: (id: string) => apiClient.delete<DeleteActivityResponse>(API_ENDPOINTS.ACTIVITIES.BY_ID(id)),
