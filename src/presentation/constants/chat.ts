...
export const CHAT_AGENT_CTA = {
  eyebrow: "تجارب ذكية بهوية خاصة",
  title: "نفس حضور رفيق بصمات… لمشروعك",
  lead: "أصمّم مساعدين بشخصية واضحة، ردود دقيقة، وتجربة تُشعر الناس أنهم أمام منتج محترف - من الفكرة حتى الإطلاق.",
  proof: "عمّار عرب · بناء تجارب ذكية",
  action: "تواصل معي",
  whatsapp:
