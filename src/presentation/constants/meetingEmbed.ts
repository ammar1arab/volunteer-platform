...
export const MEETING_LABELS = {
  ...
  hostBadge: "مدرب",
  enterAsHost: "ادخل كمدرب",
  identityVia: "الدخول عبر",
  fullscreen: "ملء الشاشة",
  exitFullscreen: "إنهاء ملء الشاشة",
  dateLabel: "التاريخ",
  timeLabel: "الوقت",
  waitingHostTitle: "بانتظار المدرب",
  waitingHostMessage: "المدرب لم يدخل القاعة بعد. سيظهر طلبك في قائمة الانتظار فور وصوله.",
  waitingAdmitTitle: "بانتظار الموافقة",
  waitingAdmitMessage: "المدرب داخل القاعة. سيتم إدخالك بعد الموافقة على طلبك.",
  deniedTitle: "لم يتم قبول دخولك",
  deniedMessage: "المدرب رفض انضمامك إلى هذا الاجتماع.",
