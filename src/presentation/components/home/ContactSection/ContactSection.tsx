...
const ContactSection = () => {
  ...
  return (
    <section className={styles.section}>
      <Container>
        <SectionHeader title="تواصل معنا" subtitle="يسعدنا التواصل معك والإجابة على جميع استفساراتك" />
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          <div className={styles.row}>
            <div className={styles.field}>
              ...
              <div className={styles.inputWrapper}>
                ...
                <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="اسمك.." className={styles.inputBase} required />
              </div>
            </div>
            <div className={styles.field}>
              ...
              <div className={styles.inputWrapper}>
                ...
                <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="بريدك.." className={styles.inputBase} required />
              </div>
            </div>
          </div>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrapper}>
              ...
              <textarea name="message" value={form.message} onChange={handleChange} placeholder="رسالتك.." className={styles.inputBase} required />
            </div>
          </div>

          <Button type="submit" variant="primary" size="md" icon={<FiSend size={15} />} iconPosition="left" disabled={status === 'loading'}>
